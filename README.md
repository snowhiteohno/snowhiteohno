...
I build games, machine learning models, and interfaces.
</p>
...
### Selected work
- 1st of 2,000+, **Daydream Hackathon** (built The Bleeding Path in Godot)
- Top 50 of 8,000+, **Meta &#215; PyTorch Hackathon** (CrashBerry)
- Top 10, **Polaris &#215; Replit Agentverse** (CodeSentinel, AI agent)
- **ARCA** mentor for the incoming SST batch
...
**Focus**&#160;&#160;`game dev` `Indic NLP` `design`
